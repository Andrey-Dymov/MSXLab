...
![Схема MSXLab: панели исследования над WebMSX и управление пользователем и ИИ](docs/images/msxlab-architecture.png)

*Схема работы: WebMSX эмулирует машину, MSXLab добавляет панели исследования и отладки, а HTTP API и MCP дают ИИ-агентам доступ к управлению.*
...
## Создано с MSXLab: Calc80

![Calc80 на MSX: заполненная таблица, выделенная ячейка и двухуровневое меню столбцов](docs/images/calc80-showcase-menu.png)

Calc80 — наше приложение электронных таблиц для MSX: формулы, форматирование ячеек, несколько листов, файлы MST/CSV и двухуровневые меню. На настоящем снимке экрана эмулятора открыты демонстрационная таблица и меню **Table → Columns**.

Приложения такого уровня теперь можно быстро создавать и удобно отлаживать с помощью **MSXLab, эмулятора WebMSX и искусственного интеллекта**. ИИ помогает писать и дорабатывать код, а лаборатория позволяет исследовать выполнение, память и результаты на эмулируемой машине. Calc80 — практический пример такой совместной работы.
